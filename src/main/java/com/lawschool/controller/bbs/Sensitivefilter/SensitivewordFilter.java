...
public class SensitivewordFilter {
	 ...
	 * 构造函数，初始化敏感词库
	 */
	public SensitivewordFilter(Set set){
	...
	public Map<String,Object> doSensitiveFifter(String string,Set sett){
		Map<String,Object> map =new HashMap<String,Object>();
		SensitivewordFilter filter = new SensitivewordFilter(sett);
