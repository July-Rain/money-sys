 ...
 *
 */
@Component("chatHandshakeInterceptorLeitai")
public class ChatHandshakeInterceptorLeitai implements HandshakeInterceptor {
	...
	public boolean beforeHandshake(ServerHttpRequest request, ServerHttpResponse response, WebSocketHandler wsHandler,
		...
		if (request instanceof ServletServerHttpRequest) {
			...
			if(session.getAttribute("loginUser")!=null){
				...
				//获取登录的用户
				MatchSetting matchSetting=(MatchSetting)session.getAttribute("matchSetting") ;
				attributes.put("matchSetting", matchSetting);
