...
//        sftpDetails.put(SFTPConstants.SFTP_REQ_PORT, "22");
        ...
        sftpDetails.put(SFTPConstants.SFTP_REQ_HOST, "192.168.0.208");
        sftpDetails.put(SFTPConstants.SFTP_REQ_USERNAME, "admin");
        sftpDetails.put(SFTPConstants.SFTP_REQ_PASSWORD, "sinorock123");
        sftpDetails.put(SFTPConstants.SFTP_REQ_PORT, "22");
