...
var vm = new Vue({
    ...
    methods: {
        ...
        redeptReload:function(){
            $.ajax({
                type: "POST",
                url: baseURL + "userIntegral/itrStatUser",
                dataType: "json",
                data: vm.formInline,
                success: function (result) {
                    if (result.code == 0) {
        ...
        obtainTableData:function(){
            $.ajax({
                type: "POST",
                url: baseURL + "userIntegral/itrStatOrg",
                dataType: "json",
                data: vm.formInline,
                success: function (result) {
                    if (result.code == 0) {
        ...
        showTableData:function(){
            ...
            for(var i = 0; i < vm.orgList.length; i++){
                ...
                statInfo.data.orgAllItr = vm.orgList[i].orgAllItr==null?0:vm.orgList[i].orgAllItr;
                statInfo.data.orgAllItrRank = vm.orgList[i].orgAllItrRank;
